                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                      ...
                      <div className="relative">
                        <div className="flex flex-col items-center justify-center absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400">&#8358;</div>
                        <input
                          type="number"
                          name="price"
                          value={formData.price}
                          onChange={handleInputChange}
                          className="w-full h-11 text-white pl-9 pr-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-700 dark:bg-gray-900 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                          placeholder="0.00"
                        />
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="text-xs text-gray-300 mt-1">Original price for showing discount</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">
                        Cost per item
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 h-11 text-white px-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-700 dark:bg-gray-900 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                      />
                      <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        onClick={addColor}
                        className="px-4 h-11 bg-emerald-500 text-white rounded-xl font-medium"
                      >
                        Add
                      </motion.button>
                    </div>
                  ...
                  <div className="pt-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={addVariant}
                        className="px-3 py-1 bg-emerald-100 text-emerald-600 rounded-lg text-sm font-medium flex items-center gap-1"
                      >
                    ...
                    <div className="space-y-3">
                      {variants.map((variant, index) => (
                        <div key={index} className="flex items-center gap-3 p-3 bg-gray-700 dark:bg-gray-900/50 rounded-xl">
                          <input
                            type="text"
                            placeholder="Size"
                            value={variant.size}
                            onChange={(e) => updateVariant(index, 'size', e.target.value)}
                            className="w-24 h-10 text-white px-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm"
                          />
                          <input
                            type="number"
                            placeholder="Price"
                          ...
                          {variants.length > 1 && (
                            <motion.button
                              ...
                              className="p-2 text-white text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-900/30 rounded-lg"
                            >
